...
if (localStorage.getItem('myTheme')) {
    ...
    let themeName = localStorage.getItem('myTheme')
    setTheme(themeName)
}
...
function storeName(displayName) {
    // Your code here
    sessionStorage.setItem('displayedName', displayName)
}

// For restoring user's display name, if set in the past
function restoreName() {
    // Your code here
    if (sessionStorage.getItem('displayedName')) {

        let displayedName = sessionStorage.getItem('displayedName')
        setInputValue(displayedName)
        sessionStorage.removeItem('displayedName')
    }
}
